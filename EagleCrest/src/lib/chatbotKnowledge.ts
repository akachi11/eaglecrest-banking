// Knowledge base for the EverestSave live chat assistant.
...
export const CHAT_TOPICS: ChatTopic[] = [
  ...
  },
  {
    ...
    answer:
      "EverestSave takes security seriously — your session is protected with token-based authentication. " +
...
export const CHAT_GREETING =
  "Hi! I'm the EverestSave assistant. Ask me about opening accounts, loan repayments, transfers, cards, savings goals, and more.";
