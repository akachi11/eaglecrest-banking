// Knowledge base for the ApexTrust live chat assistant.
...
export const CHAT_TOPICS: ChatTopic[] = [
  ...
  },
  {
    ...
    answer:
      "ApexTrust takes security seriously — your session is protected with token-based authentication. " +
...
export const CHAT_GREETING =
  "Hi! I'm the ApexTrust assistant. Ask me about opening accounts, loan repayments, transfers, cards, savings goals, and more.";
